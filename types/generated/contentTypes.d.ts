...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    enterprise: Schema.Attribute.String & Schema.Attribute.Required;
    factures: Schema.Attribute.Relation<'oneToMany', 'api::facture.facture'>;
    ...
    processStatus: Schema.Attribute.Enumeration<
      ['prospect', 'client', 'archived']
    > &
      Schema.Attribute.Required &
...
export interface ApiFactureFacture extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    facture_status: Schema.Attribute.Enumeration<
    ...
    reference: Schema.Attribute.UID &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'01-01-2025'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTechnologyTechnology extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.Enumeration<
      ['React', 'NextJS', 'PHP', 'TailwindCSS', 'NestJS', 'ExpressJS', 'Strapi']
    >;
    projects: Schema.Attribute.Relation<'manyToMany', 'api::project.project'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
